        ...
        <div className='bg-[#21325b] bg-footer_bg py-4'>
            <div className="flex justify-between  mx-auto lg:max-w-7xl md:items-center md:flex py-4">
                <div className='grid grid-cols-1 gap-8 px-6 md:grid-cols-4 mb-4 bg-footer_map bg-no-repeat'>
                    <div className="">
                        ...
                        <div className='mt-2'>
                            <a href="#" className='p-2 rounded-sm bg-[#F8F9FA]/[0.1] hover:text-[#1e2022] hover:bg-[#f8f9fa] hover:shadow-[0_4px_11px_rgb(248,249,250,0.35)] text-white text-xs'><i className='fa fa-cogs'></i> Preferences</a>
                            <a href="#" className='p-2 ml-2 rounded-sm bg-[#F8F9FA]/[0.1] hover:text-[#1e2022] hover:bg-[#f8f9fa] hover:shadow-[0_4px_11px_rgb(248,249,250,0.35)] text-white text-xs'><i className='fa fa-moon-o'></i></a>
                        </div>
                    </div>
                    <div className="mx-6">
                        <div className='ml-3'>
            ...
            <div className='flex justify-between  mx-auto lg:max-w-7xl md:items-center md:flex'>
                <div className='flex justify-between w-full px-6'>
                    <div>
                        <p className="mb-0 text-white text-xs">Etherscan © 2023 (C1)&nbsp; | &nbsp;<a className="text-[#77838f]" href="#">Donate</a> <i className="fa fa-heart text-[#de4437]" aria-hidden="true"></i></p>
                    </div>
                    <div>
                        <ul className='items-center justify-center md:flex space-x-2 md:space-y-0 inline-flex md:block'>
                            <li><a href="#" className='p-2 rounded-full bg-[#F8F9FA]/[0.1] hover:text-[#1e2022] hover:bg-[#f8f9fa] hover:shadow-[0_4px_11px_rgb(248,249,250,0.35)] text-white text-sm'><i className="fa fa-twitter"></i></a></li>
                            <li><a href="#" className='p-2 rounded-full bg-[#F8F9FA]/[0.1] hover:text-[#1e2022] hover:bg-[#f8f9fa] hover:shadow-[0_4px_11px_rgb(248,249,250,0.35)] text-white text-sm'><i className="fa fa-facebook-official"></i></a></li>
                            <li><a href="#" className='p-2 rounded-full bg-[#F8F9FA]/[0.1] hover:text-[#1e2022] hover:bg-[#f8f9fa] hover:shadow-[0_4px_11px_rgb(248,249,250,0.35)] text-white text-sm'><i className="fa fa-reddit-alien"></i></a></li>
                            <li><a href="#" className='p-2 rounded-full bg-[#F8F9FA]/[0.1] hover:text-[#1e2022] hover:bg-[#f8f9fa] hover:shadow-[0_4px_11px_rgb(248,249,250,0.35)] text-white text-sm'><i className="fa fa-medium"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
